          ...
          <div className="flex float-left w-full">
            <div className="w-2/3">
              <Tabs value={tabValue} onChange={this.handleTabClick} TabIndicatorProps={{ style: { display: 'none', } }}>
                <Tab label="Slack" className="integrations-tab shadow-md" />
                <Tab label="Email" className="integrations-tab shadow-md" />
                <Tab label="Asana" className="integrations-tab shadow-md" />
              </Tabs>
            </div>
          </div>
          <TextField id="standard-basic" className="question-text-field w-full" placeholder="Question" InputProps={{ disableUnderline: true }} />
          <div>Ask Body</div>
          <button
