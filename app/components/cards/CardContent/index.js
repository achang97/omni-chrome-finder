    ...
    return (
      <div className={s("flex-grow flex flex-col min-h-0 relative")}>
      	<div className={s("flex-grow flex flex-col min-h-0")}>
                ...
                /> :
                  ...
                  />
	        		...
	        		<TextEditor 
	        			onEditorStateChange={this.onDescriptionEditorStateChange} 
	        			editorState={this.state.descriptionEditorState} 
	        			wrapperClassName={s('text-editor-wrapper card-description-text-editor-wrapper-view overflow-auto flex-grow')} 
	        			editorClassName={s('text-editor card-description-text-editor-view')} 
	        			toolbarClassName={''} 
	        			toolbarHidden
	        			readOnly
	        ...
	        <div ref={element => this.divRef = element} className={s('p-2xl flex-grow min-h-0 overflow-auto')}>
		        { isEditing ?
		        	(answerEditorEnabled ?
			        	<TextEditor 
